...
const products = [
  { title: "Stickers troquelados", subtitle: "Cualquier forma y tamaño", image: troquelados.url, bg: "#fafafa", fit: "cover" as const },
  { title: "Etiquetas con foil metálico", subtitle: "Dorado, plateado u holográfico", image: etiquetasFoil.url, bg: "#f5f5f5", fit: "contain" as const },
  { title: "Etiquetas para tus productos", subtitle: "Vinil impermeable full color", image: stickersMarca.url, bg: "#1a1410", fit: "cover" as const },
  { title: "Banner publicitario", subtitle: "Roll up profesional con estuche", image: banner.url, bg: "#ffffff", fit: "contain" as const },
  { title: "Camisetas estampadas", subtitle: "Personalizadas full color", image: camisetasEstampadas.url, bg: "#0a0a0a", fit: "contain" as const },
  { title: "Figuras troqueladas PVC", subtitle: "Corte a medida en PVC rígido", image: figuraPvc.url, bg: "#f5f5f5", fit: "cover" as const },
  { title: "Tarjetas de presentación", subtitle: "Papel premium · acabado profesional", image: tarjetas.url, bg: "#ffffff", fit: "cover" as const },
  { title: "Menús para restaurantes", subtitle: "Laminados con espiral metálica", image: menus.url, bg: "#d9d9d9", fit: "cover" as const },
  { title: "Microperforado", subtitle: "Vinil para vidrieras y locales", image: microperforado.url, bg: "#5b6672", fit: "cover" as const },
];
    ...
    <section id="productos" className="bg-[#f8f9fa] py-24">
      <div className="mx-auto max-w-6xl px-4">
        <div className="mb-14 text-center">
          <div className="mb-3 text-xs font-semibold uppercase tracking-widest" style={{ color: "var(--brand-magenta)" }}>Productos destacados</div>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {products.map((p) => {
            ...
            return (
              <div
                key={p.title}
                className="group flex flex-col overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-black/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl"
              >
                <div
                ...
                >
                  <img
                    ...
                    alt={p.title}
                    loading="lazy"
                    className={`absolute inset-0 h-full w-full ${p.fit === "contain" ? "object-contain p-4" : "object-cover"} transition-transform duration-500 group-hover:scale-105`}
                  />
                </div>
